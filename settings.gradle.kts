...
stonecutter.create(rootProject) {
    branch("common") { versions("1.12.2", "1.16.5", "1.18.2", "1.19.2", "1.20.1", "1.21.1", "26.1.2") }
    branch("fabric") { versions("1.12.2", "1.16.5", "1.18.2", "1.19.2", "1.20.1", "1.21.1", "26.1.2") }
    // Forge stops at 1.20.1; 1.21.1 onwards is NeoForge territory.
    branch("forge") { versions("1.12.2", "1.16.5", "1.18.2", "1.19.2", "1.20.1") }
