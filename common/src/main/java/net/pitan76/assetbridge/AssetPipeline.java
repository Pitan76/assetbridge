...
public class AssetPipeline {
    ...
    private static void readBlockState(BridgedAssetManager assets, AssetArchive archive, AssetVersion version,
        ...
        if (states != null && !states.isEmpty()) {
            AssetBridge.LOGGER.debug(
                    "Ignoring {} propert{} of {} in {} for blockstate purposes: 1.12.2 registers bridged blocks without metadata-driven variants",
    ...
    private static int generateSingleItemDefinition(BridgedAssetManager assets, String itemId) {
        net.minecraft.util.ResourceLocation id = net.pitan76.assetbridge.util.ResourceLocations.tryParse(itemId);
        if (id == null) return 0;
